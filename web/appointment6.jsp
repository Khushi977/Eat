...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    ...
    <title>Dr. Madhupriya Sengupta Appointment</title>
</head>
<body>
...
<div class="doctorpicparent1" data-aos="fade-down" data-aos-duration="1200">
  <div class="doc-profile-image" data-aos="fade-in" data-aos-duration="2500" >
      ...
      <img src="./resources/img/OIP.jpeg" class="doctors-image">
  </div>
...
<div class="qualification">
    ...
    <span class="qualification-2">M.Sc In Clinical Nutrition And Dietetics</span>
</div>

<div class="languages">
    <span class="languages-1">Languages :</span>
    <span class="languages-2">English, Hindi, Bengali</span>
</div>
<div class="about">
    <p> Hi! I am Dr. Madhupriya Sengupta, a dedicated healthcare professional with over 7 years of extensive experience in the field of Clinical Nutrition and Dietetics. My journey
        in the world of nutrition has been driven by a profound passion for helping individuals achieve their health and wellness goals through tailored dietary solutions.  </p>
</div>
...
<div class="calldetails" data-aos="fade-down" data-aos-duration="1200">
    <div class="call-child1">
       <div class="call-child1-1">
        ...
        <span class="call-child1-1span">Rs 300/-</span>
        </div>

          <div class="call-child1-2">Book an appointment with Dr. Sengupta today for a hassle-free and effective audio call consultation.
          </div>
    </div>
    ...
    <div class="call-child2">
        ...
        <div class="call-child2-1"> 
            ...
            <span class="call-child1-1span">Rs 450/-</span>
        </div>
        <div class="call-child2-2">Get dedicated high-quality care and ensuring  your well-being. Book an appointment with Dr. Sengupta today
...
<input type="hidden" name="doctorName" value="Dr.Madhupriya Sengupta">
