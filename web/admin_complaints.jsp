    ...
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="http://localhost:8080/EatEase/admincomplaints" class="Dashboard">
                       <span class="material-icons">person</span>
                       <h3>Complaints</h3>
                   </a>
        ...
        <main>
            ...
            <div class="signupuser">
                ...
                <table>
                    ...
                    <tbody>
                        <c:forEach var="complaints" items="${userList}">
                        <tr>
                            
                            <td>${complaints.UEMAIL}</td>
                            <td>${complaints.UFEEDBACKISSUE}</td>
                            <td>${complaints.UCOMPLAINTS}</td>
                        </tr>
                        </c:forEach>
                    </tbody>
                </table>
