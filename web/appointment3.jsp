...
<link rel="stylesheet" href="./css/navbar&footer.css">
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>   
    <title>Dr. Rujuta Diwekar Appointment</title>
</head>
<body>
    <!-- navbar starts here -->
        <!--=============== HEADER ===============-->
...
<div class="doctorpicparent1" data-aos="fade-down" data-aos-duration="1200">
  <div class="doc-profile-image" data-aos="fade-in" data-aos-duration="2500">
      ...
      <img src="./resources/img/Rujuta-Diwekar-1.png" class="doctors-image">
  </div>
...
<div class="qualification">
    ...
    <span class="qualification-2">M. Sc FOOD SCIENCE AND NUTRITION</span>
</div>

<div class="languages">
    <span class="languages-1">Languages :</span>
    <span class="languages-2">English, Hindi, Tamil</span>
</div>
<div class="about">
    <p>Hello, I am Dr. Rujuta Diwekar, a trailblazer in the realm of nutritional medicine with a rich tapestry of 15+ years in the field. My journey as a dedicated nutrition expert has been one of passion, precision, and profound transformations.My academic prowess includes earning a coveted degree in RD (Registered Dietitian) in Nutritional Medicine.With over 15 years of professional experience, I've had the privilege of accompanying individuals on their transformative health journeys.</p>
</div>
...
<div class="calldetails" data-aos="fade-down" data-aos-duration="1200">
    <div class="call-child1">
       <div class="call-child1-1">
        ...
        <span class="call-child1-1span">Rs 350/-</span>
        </div>

          <div class="call-child1-2">Book an appointment with Dr. R Diwekar today for a hassle-free and effective audio call consultation.
          </div>
    </div>
    ...
    <div class="call-child2">
        ...
        <div class="call-child2-2">Get dedicated high-quality care and ensuring  your well-being. Book an appointment with Dr. R Diwekar today
    ...
    <div class="call-child3">
        <div class="call-child3-1">   
            ...
            <span class="call-child1-1span">Rs 150/-</span>
        </div>
...
<input type="hidden" name="doctorName" value="Dr.R Diwekar">
