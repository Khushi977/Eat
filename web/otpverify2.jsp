...
<body>
    <form action="http://localhost:8080/EatEase/verifypayOTP" method="GET" style="height: 630px;">
        ...
        <input type="number" id="otp"  name="OTP-v" placeholder="0 0 0 0 0 0" required>
         ...
         <div style="margin-top: 20px"><a href="user_profile.jsp" style="text-decoration: none;">Back to home</a></div>
