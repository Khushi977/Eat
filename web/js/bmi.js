...
// Event listener to show the button when clicked
showButton.addEventListener("Click", displayButton);

// Simulate giving some output (you can replace this with your actual output)
setTimeout(function() {
  // containerResult.innerHTML = "Output has been given!";
    displayButton();
}, 8000); // Display output after 2 seconds (for demonstration purposes)
