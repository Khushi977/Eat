        ...
        <div class="cont-container">
            <div class="main">
                <div class="content-contact">
                    <h2>Contact Us</h2>
                    <form  action="https://formspree.io/f/mvojllpk" method="POST">
                        <input type="text" name="name" placeholder="Enter Your Name" required style="text-transform: none">
                        <input type="email" name="email" required   pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$"
                               placeholder="Enter Your Email" style="text-transform: none">
                        <!-- <textarea name="message" placeholder="Your Message"></textarea> -->
                        <input class="messageinput" type="text" name="Message" required placeholder="Your Message">
                        
                        <input type="hidden" name="_template" value="table">
                        <input type="hidden" name="_autoresponse" value="Thank You">
                         <input type="hidden" name="_captcha" value="false">
                         <input type="hidden" name="_subject" value="Contact Us Submission">
             <button type="submit" class="btn">Send <i class="fas fa-paper-plane"></i></button>
                    </form>
                </div>
                <div class="form-img">
                    <img src="./resources/img/contact-bg.png" alt="">
                </div>
            </div>
        </div>
        <!-- <div class="popup">
