    ...
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="http://localhost:8080/EatEase/adminbmiformdata" class="Dashboard">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Gender</th>
                            <th>Weight</th>
                            <th>Diet Prefrence</th>
                           
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="bmiformdata" items="${userList}">
                        <tr>
                            <td>${bmiformdata.UNAME}</td>
                            <td>${bmiformdata.UEMAIL}</td>
                            <td>${bmiformdata.UAGE}</td>
                            <td>${bmiformdata.UGENDER}</td>
                            <td>${bmiformdata.UWEIGHT}</td>
                            <td>${bmiformdata.UDIETPREFERENCE}</td>
