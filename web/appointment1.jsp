...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
    ...
    <title>Dr. Rajesh Desouza Appointment</title>
</head>
<body>
...
<div class="doctorpicparent1" data-aos="fade-down" data-aos-duration="1200" >
  <div class="doc-profile-image" data-aos="fade-in" data-aos-duration="2500">
      ...
      <img src="./resources/img/gents.jpg" class="doctors-image">
  </div>
...
<div class="qualification">
    ...
    <span class="qualification-2">RD In Nutritional Medicine</span>
</div>

<div class="languages">
    <span class="languages-1">Languages :</span>
    <span class="languages-2">English, Hindi</span>
</div>
<div class="about">
    <p>Hello, I am Dr. Rajesh Desouza, a stalwart in the field of nutritional medicine with more than two decades of dedicated service. My journey as a nutrition expert
        has been a remarkable odyssey, driven by an unyielding passion for promoting health and well-being through dietary excellence. With over 20 years of hands-on experience, I have had the privilege of guiding individuals from all walks of life toward a healthier, more vibrant existence.</p>
</div>
...
<div class="calldetails" data-aos="fade-down" data-aos-duration="1200">
    <div class="call-child1">
       <div class="call-child1-1">
        ...
        <span class="call-child1-1span">Rs 400/-</span>
          ...
          <div class="call-child1-2">Book an appointment with Dr. R Desouza today for a hassle-free and effective audio call consultation.
          </div>
    </div>
    ...
    <div class="call-child2">
        ...
        <div class="call-child2-1"> 
            ...
            <span class="call-child1-1span">Rs 550/-</span>
        </div>
        <div class="call-child2-2">Get dedicated high-quality care and ensuring  your well-being. Book an appointment with Dr. R Desouza today
    ...
    <div class="call-child3">
        <div class="call-child3-1">   
            ...
            <span class="call-child1-1span">Rs 200/-</span>
        </div>
...
<input type="hidden" name="doctorName" value="Dr.Rajesh Desouza">
