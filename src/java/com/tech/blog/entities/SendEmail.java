...
//            message.setRecipient(Message.RecipientType.TO, new InternetAddress(toEmail));
            ...
            String messageText = "Your OTP: " + otp + "<br/><br/>Click the following link to verify:<br/><a href='http://localhost:8080/EatEase/otpverify.jsp'>http://localhost:8080/EatEase/otpverify</a>"
